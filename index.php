<?php
/**
 * index.php along with survey_view.php.php provides a sample web application
 *
 * The difference between demo_list.php and index.php is the reference to the 
 * Pager class which processes a mysqli SQL statement and spans records across multiple  
 * pages. 
 *
 * The associated view page, survey_view.php.php is virtually identical to demo_view.php. 
...
<p>This page, along with <b>survey_view.php.php</b>, demonstrate a List/View web application.</p>
...
<p>Use <b>index.php</b> and <b>survey_view.php.php</b> as a starting point for building your own List/View web application!</p> 
<?php
...
{#records exist - process
	...
	{# process each row
         echo '<div align="center"><a href="' . VIRTUAL_PATH . 'survey/survey_view.php.php?id=' . (int)$row['SurveyID'] . '">' . dbOut($row['title']) . '</a>';
